  ...
  return (
    <div className='header'>
      <Carousel autoPlay infiniteLoop showThumbs={false} showIndicators={false} showArrows={false} showStatus={false}>
        ...
        <div>
          <img className="headerImg" src="https://cdn.pixabay.com/photo/2016/11/21/16/09/bible-1846174_960_720.jpg" />
        </div>
        <div>
          <img className="headerImg" src="https://cdn.pixabay.com/photo/2017/08/22/00/38/meadow-2667461_960_720.jpg" />
        </div>
      </Carousel>
    </div>
  );
